...
public abstract class ImageWorker {
    ...
    private boolean isRoundDrawable;
...
//            Util.makeRoundDrawable(value, GKApplication.getInstance(),false);
        ...
        if (mFadeInBitmap) {
            ...
            final TransitionDrawable td =
                    new TransitionDrawable(new Drawable[]{
                            ...
                            isRoundDrawable ?
                                    new BitmapDrawable(mResources, Util.makeRoundDrawable(drawable, GKApplication.getInstance(), false)) : drawable
                    });
            // Set background to loading bitmap
            imageView.setBackgroundDrawable(isRoundDrawable ?
                    new BitmapDrawable(mResources, Util.makeRoundDrawable(drawable, GKApplication.getInstance(), false)) :
     ...
     * scrolling smooth.
     * <p/>
     * If work is paused, be sure setPauseAllWork(false) is called again
