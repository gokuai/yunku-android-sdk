package com.gokuai.yunkuandroidsdktest.compat.v2;
...
public class GKAPITest extends AndroidTestCase {
    ...
    public void testRename() throws Exception {
        ...
        FileDataManager.getInstance().rename("test1.jpg", "test.jpg", new FileDataManager.DataListener() {
            @Override
    ...
    public void testAddFile() throws Exception {
        ...
        FileDataManager.getInstance().addFile("addFile.jpg", path, new UploadCallBack() {
            @Override
    ...
    public void testAddDir() throws Exception {
        ...
        FileDataManager.getInstance().addDir("gokuai", new FileDataManager.DataListener() {
            @Override
            public void onReceiveHttpResponse(int actionId) {
                latch.countDown();
                Log.i(TAG, "addDir-->" + actionId + "");
    ...
    public void testDel() throws Exception {
        ...
        FileDataManager.getInstance().del("addFile.jpg", new FileDataManager.DataListener() {
            @Override
            public void onReceiveHttpResponse(int actionId) {
                latch.countDown();
