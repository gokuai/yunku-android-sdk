...
public class PdfPage implements CodecPage {
    ...
    public PdfPage(MuPDFCore core, long pageHandle) {
        ...
        this.pdfPageWidth = (int) (core.getPDFPageWidth());
        this.pdfPageHeight = (int) (core.getPDFPageHeight());
    }
