...
public class MuPDFReaderView extends AKReaderView {
	...
	public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX,
		...
		case Viewing:
			...
			if (Math.abs(e2.getX()-e1.getX())<width) {	//TODO 修改垂直滚动锁定.
				return super.onScroll(e1, e2, 0, distanceY);
			} else {
	...
	public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
		...
		switch (mMode) {
		case Viewing:
			return super.onFling(e1, e2, 0, velocityY);	//TODO 修改垂直滚动锁定.
		default:
			return true;
		}
	}
